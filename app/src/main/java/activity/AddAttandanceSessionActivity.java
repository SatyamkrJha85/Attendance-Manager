...
import activity.AddAttendanceActivity;
import activity.ViewAttendanceByFacultyActivity;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				FacultyBean bean=((context.ApplicationContext)AddAttandanceSessionActivity.this.getApplicationContext()).getFacultyBean();
		...
		viewAttendance.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				((context.ApplicationContext)AddAttandanceSessionActivity.this.getApplicationContext()).setAttendanceBeanList(attendanceBeanList);
